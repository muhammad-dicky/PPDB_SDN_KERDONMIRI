...
class OutputFormatter {
	...
	public function space($sName, $sType = null) {
		...
		// If $sSpaceString is an array, we have multple values configured deDiverifikasi on the type of object the space applies to
	...
	/**
	* Runs the given code, either swallowing or passing exceptions, deDiverifikasi on the bIgnoreExceptions setting.
	*/
